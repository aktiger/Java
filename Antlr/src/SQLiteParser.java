// Generated from SQLite.g4 by ANTLR 4.2
...
public class SQLiteParser extends Parser {
	...
	public static final int
		...
		RULE_unary_operator = 59, RULE_error_message = 60, RULE_binary_operator = 61, 
	...
	public static final String[] ruleNames = {
		...
		"signed_number", "literal_value", "unary_operator", "error_message", "binary_operator", 
	...
	public final ErrorContext error() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(175); match(UNEXPECTED_CHAR);
	...
	public final Sql_stmtContext sql_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_EXPLAIN) {
				{
				setState(202); match(K_EXPLAIN);
				setState(205);
				_la = _input.LA(1);
				if (_la==K_QUERY) {
					{
					setState(203); match(K_QUERY);
					setState(204); match(K_PLAN);
					}
				}
			...
			case 1:
				{
				setState(209); alter_table_stmt();
				}
				break;

			case 2:
				{
				setState(210); analyze_stmt();
				}
				break;

			case 3:
				{
				setState(211); attach_stmt();
				}
				break;

			case 4:
				{
				setState(212); begin_stmt();
				}
				break;

			case 5:
				{
				setState(213); commit_stmt();
				}
				break;

			case 6:
				{
				setState(214); compound_select_stmt();
				}
				break;

			case 7:
				{
				setState(215); create_index_stmt();
				}
				break;

			case 8:
				{
				setState(216); create_table_stmt();
				}
				break;

			case 9:
				{
				setState(217); create_trigger_stmt();
				}
				break;

			case 10:
				{
				setState(218); create_view_stmt();
				}
				break;

			case 11:
				{
				setState(219); create_virtual_table_stmt();
				}
				break;

			case 12:
				{
				setState(220); delete_stmt();
				}
				break;

			case 13:
				{
				setState(221); delete_stmt_limited();
				}
				break;

			case 14:
				{
				setState(222); detach_stmt();
				}
				break;

			case 15:
				{
				setState(223); drop_index_stmt();
				}
				break;

			case 16:
				{
				setState(224); drop_table_stmt();
				}
				break;

			case 17:
				{
				setState(225); drop_trigger_stmt();
				}
				break;

			case 18:
				{
				setState(226); drop_view_stmt();
				}
				break;

			case 19:
				{
				setState(227); factored_select_stmt();
				}
				break;

			case 20:
				{
				setState(228); insert_stmt();
				}
				break;

			case 21:
				{
				setState(229); pragma_stmt();
				}
				break;

			case 22:
				{
				setState(230); reindex_stmt();
				}
				break;

			case 23:
				{
				setState(231); release_stmt();
				}
				break;

			case 24:
				{
				setState(232); rollback_stmt();
				}
				break;

			case 25:
				{
				setState(233); savepoint_stmt();
				}
				break;

			case 26:
				{
				setState(234); simple_select_stmt();
				}
				break;

			case 27:
				{
				setState(235); select_stmt();
				}
				break;

			case 28:
				{
				setState(236); update_stmt();
				}
				break;

			case 29:
				{
				setState(237); update_stmt_limited();
				}
				break;

			case 30:
				{
				setState(238); vacuum_stmt();
				}
				break;
			}
			}
	...
	public final Alter_table_stmtContext alter_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(241); match(K_ALTER);
			setState(242); match(K_TABLE);
			setState(246);
			switch ( getInterpreter().adaptivePredict(_input,9,_ctx) ) {
			case 1:
				{
				setState(243); database_name();
				setState(244); match(DOT);
				}
				break;
			}
			setState(248); table_name();
			setState(257);
			switch (_input.LA(1)) {
			case K_RENAME:
				{
				setState(249); match(K_RENAME);
				setState(250); match(K_TO);
				setState(251); new_table_name();
				}
				break;
			case K_ADD:
				{
				setState(252); match(K_ADD);
				setState(254);
				switch ( getInterpreter().adaptivePredict(_input,10,_ctx) ) {
				case 1:
					{
					setState(253); match(K_COLUMN);
					}
					break;
				}
				setState(256); column_def();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Analyze_stmtContext analyze_stmt() throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				setState(261); table_or_index_name();
				}
				break;

			case 3:
				{
				setState(262); database_name();
				setState(263); match(DOT);
				setState(264); table_or_index_name();
				}
				break;
			}
			}
	...
	public final Attach_stmtContext attach_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(268); match(K_ATTACH);
			setState(270);
			switch ( getInterpreter().adaptivePredict(_input,13,_ctx) ) {
			case 1:
				{
				setState(269); match(K_DATABASE);
				}
				break;
			}
			setState(272); expr(0);
			setState(273); match(K_AS);
			setState(274); database_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Begin_stmtContext begin_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_TRANSACTION) {
				{
				setState(280); match(K_TRANSACTION);
				setState(282);
				switch ( getInterpreter().adaptivePredict(_input,15,_ctx) ) {
				case 1:
					{
					setState(281); transaction_name();
					}
					break;
				}
				}
	...
	public final Commit_stmtContext commit_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_TRANSACTION) {
				{
				setState(287); match(K_TRANSACTION);
				setState(289);
				switch ( getInterpreter().adaptivePredict(_input,17,_ctx) ) {
				case 1:
					{
					setState(288); transaction_name();
					}
					break;
				}
				}
	...
	public final Compound_select_stmtContext compound_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(293); match(K_WITH);
				setState(295);
				switch ( getInterpreter().adaptivePredict(_input,19,_ctx) ) {
				case 1:
					{
					setState(294); match(K_RECURSIVE);
					}
					break;
				}
				...
				while (_la==COMMA) {
					...
					setState(299); common_table_expression();
					}
					}
					setState(304);
					_errHandler.sync(this);
			...
			do {
				...
				case K_UNION:
					{
					setState(308); match(K_UNION);
					setState(310);
					_la = _input.LA(1);
					if (_la==K_ALL) {
						{
						setState(309); match(K_ALL);
						}
					}
				...
				case K_INTERSECT:
					{
					setState(312); match(K_INTERSECT);
					}
					break;
				case K_EXCEPT:
					{
					setState(313); match(K_EXCEPT);
					}
					break;
				default:
					throw new NoViableAltException(this);
				}
				setState(316); select_core();
				}
				}
				setState(319); 
				_errHandler.sync(this);
			...
			if (_la==K_ORDER) {
				{
				setState(321); match(K_ORDER);
				setState(322); match(K_BY);
	...
	public final Create_index_stmtContext create_index_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(341); match(K_CREATE);
			setState(343);
			_la = _input.LA(1);
			if (_la==K_UNIQUE) {
				{
				setState(342); match(K_UNIQUE);
				}
			}

			setState(345); match(K_INDEX);
			setState(349);
			switch ( getInterpreter().adaptivePredict(_input,30,_ctx) ) {
			case 1:
				{
				setState(346); match(K_IF);
				setState(347); match(K_NOT);
				setState(348); match(K_EXISTS);
				}
				break;
			}
			setState(354);
			...
			case 1:
				{
				setState(351); database_name();
				setState(352); match(DOT);
				}
				break;
			}
			setState(356); index_name();
			setState(357); match(K_ON);
	...
	public final Create_table_stmtContext create_table_stmt() throws RecognitionException {
		...
		try {
			...
			setState(377); match(K_TABLE);
			setState(381);
			switch ( getInterpreter().adaptivePredict(_input,35,_ctx) ) {
			case 1:
				{
				setState(378); match(K_IF);
				setState(379); match(K_NOT);
				setState(380); match(K_EXISTS);
				}
				break;
			}
			setState(386);
			...
			case 1:
				{
				setState(383); database_name();
				setState(384); match(DOT);
				}
				break;
			}
			setState(388); table_name();
			setState(412);
			switch (_input.LA(1)) {
			case OPEN_PAR:
				{
				...
				setState(405); match(CLOSE_PAR);
				setState(408);
				_la = _input.LA(1);
				if (_la==K_WITHOUT) {
					{
					setState(406); match(K_WITHOUT);
			...
			case K_AS:
				{
				setState(410); match(K_AS);
				setState(411); select_stmt();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Create_trigger_stmtContext create_trigger_stmt() throws RecognitionException {
		...
		try {
			...
			setState(418); match(K_TRIGGER);
			setState(422);
			switch ( getInterpreter().adaptivePredict(_input,42,_ctx) ) {
			case 1:
				{
				setState(419); match(K_IF);
				setState(420); match(K_NOT);
				setState(421); match(K_EXISTS);
				}
				break;
			}
			setState(427);
			...
			case 1:
				{
				setState(424); database_name();
				setState(425); match(DOT);
				}
				break;
			}
			setState(429); trigger_name();
			setState(434);
			switch (_input.LA(1)) {
			case K_BEFORE:
				{
				setState(430); match(K_BEFORE);
				}
				break;
			case K_AFTER:
				{
				setState(431); match(K_AFTER);
				}
				break;
			case K_INSTEAD:
				{
				setState(432); match(K_INSTEAD);
				setState(433); match(K_OF);
				}
				break;
			case K_DELETE:
			case K_INSERT:
			...
			case K_INSERT:
				{
				setState(437); match(K_INSERT);
				}
				break;
			case K_UPDATE:
				{
				setState(438); match(K_UPDATE);
				setState(448);
				_la = _input.LA(1);
				if (_la==K_OF) {
					{
					setState(439); match(K_OF);
			...
			setState(452); match(K_ON);
			setState(456);
			switch ( getInterpreter().adaptivePredict(_input,48,_ctx) ) {
			case 1:
				{
				setState(453); database_name();
				setState(454); match(DOT);
				}
				break;
			}
			setState(458); table_name();
			setState(462);
			_la = _input.LA(1);
			if (_la==K_FOR) {
				{
				setState(459); match(K_FOR);
				setState(460); match(K_EACH);
				setState(461); match(K_ROW);
				}
			}
			...
			if (_la==K_WHEN) {
				{
				setState(464); match(K_WHEN);
				setState(465); expr(0);
				}
			}

			setState(468); match(K_BEGIN);
			setState(477); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				case 1:
					{
					setState(469); update_stmt();
					}
					break;

				case 2:
					{
					setState(470); insert_stmt();
					}
					break;

				case 3:
					{
					setState(471); delete_stmt();
					}
					break;

				case 4:
					{
					setState(472); select_stmt();
					}
					break;
				}
				setState(475); match(SCOL);
				}
				}
				setState(479); 
				_errHandler.sync(this);
	...
	public final Create_view_stmtContext create_view_stmt() throws RecognitionException {
		...
		try {
			...
			setState(487); match(K_VIEW);
			setState(491);
			switch ( getInterpreter().adaptivePredict(_input,54,_ctx) ) {
			case 1:
				{
				setState(488); match(K_IF);
				setState(489); match(K_NOT);
				setState(490); match(K_EXISTS);
				}
				break;
			}
			setState(496);
			...
			case 1:
				{
				setState(493); database_name();
				setState(494); match(DOT);
				}
				break;
			}
			setState(498); view_name();
			setState(499); match(K_AS);
			setState(500); select_stmt();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Create_virtual_table_stmtContext create_virtual_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(502); match(K_CREATE);
			setState(503); match(K_VIRTUAL);
			setState(504); match(K_TABLE);
			setState(508);
			switch ( getInterpreter().adaptivePredict(_input,56,_ctx) ) {
			case 1:
				{
				setState(505); match(K_IF);
				setState(506); match(K_NOT);
				setState(507); match(K_EXISTS);
				}
				break;
			}
			setState(513);
			...
			case 1:
				{
				setState(510); database_name();
				setState(511); match(DOT);
				}
				break;
			}
			setState(515); table_name();
			setState(516); match(K_USING);
			setState(517); module_name();
			setState(529);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
	...
	public final Delete_stmtContext delete_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(531); with_clause();
				}
			}

			setState(534); match(K_DELETE);
			setState(535); match(K_FROM);
			setState(536); qualified_table_name();
			setState(539);
			_la = _input.LA(1);
			if (_la==K_WHERE) {
				{
				setState(537); match(K_WHERE);
				setState(538); expr(0);
				}
			}
	...
	public final Delete_stmt_limitedContext delete_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(541); with_clause();
				}
			}

			setState(544); match(K_DELETE);
			setState(545); match(K_FROM);
			setState(546); qualified_table_name();
			setState(549);
			_la = _input.LA(1);
			if (_la==K_WHERE) {
				{
				setState(547); match(K_WHERE);
				setState(548); expr(0);
				}
			}
			...
			if (_la==K_LIMIT || _la==K_ORDER) {
				...
				if (_la==K_ORDER) {
					{
					setState(551); match(K_ORDER);
					setState(552); match(K_BY);
	...
	public final Detach_stmtContext detach_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(571); match(K_DETACH);
			setState(573);
			switch ( getInterpreter().adaptivePredict(_input,68,_ctx) ) {
			case 1:
				{
				setState(572); match(K_DATABASE);
				}
				break;
			}
			setState(575); database_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_index_stmtContext drop_index_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(577); match(K_DROP);
			setState(578); match(K_INDEX);
			setState(581);
			switch ( getInterpreter().adaptivePredict(_input,69,_ctx) ) {
			case 1:
				{
				setState(579); match(K_IF);
				setState(580); match(K_EXISTS);
				}
				break;
			}
			setState(586);
			...
			case 1:
				{
				setState(583); database_name();
				setState(584); match(DOT);
				}
				break;
			}
			setState(588); index_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_table_stmtContext drop_table_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(590); match(K_DROP);
			setState(591); match(K_TABLE);
			setState(594);
			switch ( getInterpreter().adaptivePredict(_input,71,_ctx) ) {
			case 1:
				{
				setState(592); match(K_IF);
				setState(593); match(K_EXISTS);
				}
				break;
			}
			setState(599);
			...
			case 1:
				{
				setState(596); database_name();
				setState(597); match(DOT);
				}
				break;
			}
			setState(601); table_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_trigger_stmtContext drop_trigger_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(603); match(K_DROP);
			setState(604); match(K_TRIGGER);
			setState(607);
			switch ( getInterpreter().adaptivePredict(_input,73,_ctx) ) {
			case 1:
				{
				setState(605); match(K_IF);
				setState(606); match(K_EXISTS);
				}
				break;
			}
			setState(612);
			...
			case 1:
				{
				setState(609); database_name();
				setState(610); match(DOT);
				}
				break;
			}
			setState(614); trigger_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Drop_view_stmtContext drop_view_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(616); match(K_DROP);
			setState(617); match(K_VIEW);
			setState(620);
			switch ( getInterpreter().adaptivePredict(_input,75,_ctx) ) {
			case 1:
				{
				setState(618); match(K_IF);
				setState(619); match(K_EXISTS);
				}
				break;
			}
			setState(625);
	...
	public final Factored_select_stmtContext factored_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(629); match(K_WITH);
				setState(631);
				switch ( getInterpreter().adaptivePredict(_input,77,_ctx) ) {
				case 1:
					{
					setState(630); match(K_RECURSIVE);
					}
					break;
				}
				...
				while (_la==COMMA) {
					...
					setState(635); common_table_expression();
					}
					}
					setState(640);
					_errHandler.sync(this);
			...
			while (_la==K_EXCEPT || _la==K_INTERSECT || _la==K_UNION) {
				{
				{
				setState(644); compound_operator();
				setState(645); select_core();
				}
				}
				setState(651);
				_errHandler.sync(this);
			...
			if (_la==K_ORDER) {
				{
				setState(652); match(K_ORDER);
				setState(653); match(K_BY);
	...
	public final Insert_stmtContext insert_stmt() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(675); match(K_INSERT);
				}
				break;

			case 2:
				{
				setState(676); match(K_REPLACE);
				}
				break;

			case 3:
				{
				setState(677); match(K_INSERT);
				setState(678); match(K_OR);
				setState(679); match(K_REPLACE);
				}
				break;

			case 4:
				{
				setState(680); match(K_INSERT);
				setState(681); match(K_OR);
				setState(682); match(K_ROLLBACK);
				}
				break;

			case 5:
				{
				setState(683); match(K_INSERT);
				setState(684); match(K_OR);
				setState(685); match(K_ABORT);
				}
				break;

			case 6:
				{
				setState(686); match(K_INSERT);
				setState(687); match(K_OR);
				setState(688); match(K_FAIL);
				}
				break;

			case 7:
				{
				setState(689); match(K_INSERT);
				setState(690); match(K_OR);
				setState(691); match(K_IGNORE);
				}
				break;
			}
			setState(694); match(K_INTO);
			setState(698);
			switch ( getInterpreter().adaptivePredict(_input,87,_ctx) ) {
			case 1:
				{
				setState(695); database_name();
				setState(696); match(DOT);
				}
				break;
			}
			setState(700); table_name();
			setState(712);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(701); match(OPEN_PAR);
			...
			case 1:
				{
				setState(714); match(K_VALUES);
				setState(715); match(OPEN_PAR);
				setState(716); expr(0);
				setState(721);
				_errHandler.sync(this);
				_la = _input.LA(1);
			...
			case 2:
				{
				setState(742); select_stmt();
				}
				break;

			case 3:
				{
				setState(743); match(K_DEFAULT);
				setState(744); match(K_VALUES);
				}
				break;
			}
			}
	...
	public final Pragma_stmtContext pragma_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(747); match(K_PRAGMA);
			setState(751);
			switch ( getInterpreter().adaptivePredict(_input,94,_ctx) ) {
			case 1:
				{
				setState(748); database_name();
				setState(749); match(DOT);
				}
				break;
			}
			setState(753); pragma_name();
			setState(760);
			switch (_input.LA(1)) {
			case ASSIGN:
				{
				setState(754); match(ASSIGN);
				setState(755); pragma_value();
				}
				break;
			case OPEN_PAR:
				{
				setState(756); match(OPEN_PAR);
				setState(757); pragma_value();
	...
	public final Reindex_stmtContext reindex_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(762); match(K_REINDEX);
			setState(773);
			switch ( getInterpreter().adaptivePredict(_input,98,_ctx) ) {
			case 1:
				{
				setState(763); collation_name();
				}
				break;
			...
			case 2:
				...
				case 1:
					{
					setState(769); table_name();
					}
					break;

				case 2:
					{
					setState(770); index_name();
					}
					break;
				}
				}
	...
	public final Release_stmtContext release_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(775); match(K_RELEASE);
			setState(777);
			switch ( getInterpreter().adaptivePredict(_input,99,_ctx) ) {
			case 1:
				{
				setState(776); match(K_SAVEPOINT);
				}
				break;
			}
			setState(779); savepoint_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Rollback_stmtContext rollback_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(781); match(K_ROLLBACK);
			setState(786);
			_la = _input.LA(1);
			if (_la==K_TRANSACTION) {
				{
				setState(782); match(K_TRANSACTION);
				setState(784);
				switch ( getInterpreter().adaptivePredict(_input,100,_ctx) ) {
				case 1:
					{
					setState(783); transaction_name();
					}
					break;
				}
				}
			...
			if (_la==K_TO) {
				{
				setState(788); match(K_TO);
				setState(790);
				switch ( getInterpreter().adaptivePredict(_input,102,_ctx) ) {
				case 1:
					{
					setState(789); match(K_SAVEPOINT);
					}
					break;
				}
				setState(792); savepoint_name();
				}
			}
	...
	public final Savepoint_stmtContext savepoint_stmt() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(795); match(K_SAVEPOINT);
			setState(796); savepoint_name();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Simple_select_stmtContext simple_select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(798); match(K_WITH);
				setState(800);
				switch ( getInterpreter().adaptivePredict(_input,104,_ctx) ) {
				case 1:
					{
					setState(799); match(K_RECURSIVE);
					}
					break;
				}
				...
				while (_la==COMMA) {
					...
					setState(804); common_table_expression();
					}
					}
					setState(809);
					_errHandler.sync(this);
			...
			setState(812); select_core();
			setState(823);
			_la = _input.LA(1);
			if (_la==K_ORDER) {
				{
				setState(813); match(K_ORDER);
				setState(814); match(K_BY);
	...
	public final Select_stmtContext select_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(833); match(K_WITH);
				setState(835);
				switch ( getInterpreter().adaptivePredict(_input,111,_ctx) ) {
				case 1:
					{
					setState(834); match(K_RECURSIVE);
					}
					break;
				}
				...
				while (_la==COMMA) {
					...
					setState(839); common_table_expression();
					}
					}
					setState(844);
					_errHandler.sync(this);
			...
			while (_la==K_EXCEPT || _la==K_INTERSECT || _la==K_UNION) {
				{
				{
				setState(848); compound_operator();
				setState(849); select_or_values();
				}
				}
				setState(855);
				_errHandler.sync(this);
			...
			if (_la==K_ORDER) {
				{
				setState(856); match(K_ORDER);
				setState(857); match(K_BY);
	...
	public final Select_or_valuesContext select_or_values() throws RecognitionException {
		...
		try {
			...
			case K_SELECT:
				...
				if (_la==K_FROM) {
					...
					case 1:
						...
						while (_la==COMMA) {
							...
							setState(891); table_or_subquery();
							}
							}
							setState(896);
							_errHandler.sync(this);
				...
				if (_la==K_GROUP) {
					{
					setState(906); match(K_GROUP);
					setState(907); match(K_BY);
					setState(908); expr(0);
					setState(913);
					_errHandler.sync(this);
					_la = _input.LA(1);
			...
			case K_VALUES:
				...
				{
				setState(922); match(K_VALUES);
				setState(923); match(OPEN_PAR);
				setState(924); expr(0);
				setState(929);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final Update_stmtContext update_stmt() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(952); with_clause();
				}
			}

			setState(955); match(K_UPDATE);
			setState(966);
			switch ( getInterpreter().adaptivePredict(_input,133,_ctx) ) {
			case 1:
				{
				setState(956); match(K_OR);
				setState(957); match(K_ROLLBACK);
				}
				break;
			...
			case 4:
				...
				setState(963); match(K_FAIL);
				}
				break;

			case 5:
				{
				setState(964); match(K_OR);
				setState(965); match(K_IGNORE);
				}
				break;
			}
			setState(968); qualified_table_name();
			setState(969); match(K_SET);
			setState(970); column_name();
			setState(971); match(ASSIGN);
			setState(972); expr(0);
			setState(980);
			_errHandler.sync(this);
			_la = _input.LA(1);
	...
	public final Update_stmt_limitedContext update_stmt_limited() throws RecognitionException {
		...
		try {
			...
			if (_la==K_WITH) {
				{
				setState(987); with_clause();
				}
			}

			setState(990); match(K_UPDATE);
			setState(1001);
			switch ( getInterpreter().adaptivePredict(_input,137,_ctx) ) {
			case 1:
				{
				setState(991); match(K_OR);
				setState(992); match(K_ROLLBACK);
				}
				break;

			case 2:
				{
				setState(993); match(K_OR);
				setState(994); match(K_ABORT);
				}
				break;

			case 3:
				{
				setState(995); match(K_OR);
				setState(996); match(K_REPLACE);
				}
				break;

			case 4:
				{
				setState(997); match(K_OR);
				setState(998); match(K_FAIL);
				}
				break;

			case 5:
				{
				setState(999); match(K_OR);
				setState(1000); match(K_IGNORE);
				}
				break;
			}
			setState(1003); qualified_table_name();
			setState(1004); match(K_SET);
			setState(1005); column_name();
			setState(1006); match(ASSIGN);
			setState(1007); expr(0);
			setState(1015);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1009); column_name();
				setState(1010); match(ASSIGN);
				setState(1011); expr(0);
				}
				}
				setState(1017);
				_errHandler.sync(this);
			...
			if (_la==K_WHERE) {
				{
				setState(1018); match(K_WHERE);
				setState(1019); expr(0);
				}
			}
			...
			if (_la==K_LIMIT || _la==K_ORDER) {
				...
				if (_la==K_ORDER) {
					{
					setState(1022); match(K_ORDER);
					setState(1023); match(K_BY);
	...
	public final Column_defContext column_def() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1044); column_name();
			setState(1046);
			switch ( getInterpreter().adaptivePredict(_input,144,_ctx) ) {
			case 1:
				{
				setState(1045); type_name();
				}
				break;
			}
			setState(1051);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << K_CHECK) | (1L << K_COLLATE) | (1L << K_CONSTRAINT) | (1L << K_DEFAULT))) != 0) || ((((_la - 102)) & ~0x3f) == 0 && ((1L << (_la - 102)) & ((1L << (K_NOT - 102)) | (1L << (K_NULL - 102)) | (1L << (K_PRIMARY - 102)) | (1L << (K_REFERENCES - 102)) | (1L << (K_UNIQUE - 102)))) != 0)) {
				{
				{
				setState(1048); column_constraint();
				}
				}
				setState(1053);
				_errHandler.sync(this);
	...
	public final Type_nameContext type_name() throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				setState(1063); match(OPEN_PAR);
				setState(1064); signed_number();
				setState(1065); match(COMMA);
				setState(1066); signed_number();
				setState(1067); match(CLOSE_PAR);
				}
				break;
			}
			}
	...
	public final Column_constraintContext column_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==K_CONSTRAINT) {
				{
				setState(1071); match(K_CONSTRAINT);
				setState(1072); name();
				}
			}
			...
			case K_PRIMARY:
				{
				setState(1075); match(K_PRIMARY);
				setState(1076); match(K_KEY);
				setState(1078);
				_la = _input.LA(1);
				...
				setState(1080); conflict_clause();
				setState(1082);
				_la = _input.LA(1);
				if (_la==K_AUTOINCREMENT) {
					{
					setState(1081); match(K_AUTOINCREMENT);
					}
				}
			...
			case K_NULL:
				...
				if (_la==K_NOT) {
					{
					setState(1084); match(K_NOT);
					}
				}

				setState(1087); match(K_NULL);
				setState(1088); conflict_clause();
				}
				break;
			case K_UNIQUE:
				{
				setState(1089); match(K_UNIQUE);
				setState(1090); conflict_clause();
				}
				break;
			case K_CHECK:
				{
				setState(1091); match(K_CHECK);
				setState(1092); match(OPEN_PAR);
				setState(1093); expr(0);
				setState(1094); match(CLOSE_PAR);
				}
				break;
			case K_DEFAULT:
				{
				setState(1096); match(K_DEFAULT);
				setState(1103);
				switch ( getInterpreter().adaptivePredict(_input,152,_ctx) ) {
				case 1:
					{
					setState(1097); signed_number();
					}
					break;

				case 2:
					{
					setState(1098); literal_value();
					}
					break;

				case 3:
					{
					setState(1099); match(OPEN_PAR);
					setState(1100); expr(0);
					setState(1101); match(CLOSE_PAR);
					}
					break;
				}
				}
			...
			case K_COLLATE:
				{
				setState(1105); match(K_COLLATE);
				setState(1106); collation_name();
				}
				break;
			case K_REFERENCES:
				{
				setState(1107); foreign_key_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Conflict_clauseContext conflict_clause() throws RecognitionException {
		...
		try {
			...
			if (_la==K_ON) {
				{
				setState(1110); match(K_ON);
				setState(1111); match(K_CONFLICT);
				setState(1112);
				_la = _input.LA(1);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1116); unary_operator();
				setState(1117); expr(14);
				}
				break;

			case 2:
				{
				setState(1119); literal_value();
				}
				break;

			case 3:
				{
				setState(1120); match(BIND_PARAMETER);
				}
				break;
			...
			case 4:
				...
				case 1:
					...
					case 1:
						{
						setState(1121); database_name();
						setState(1122); match(DOT);
						}
						break;
					}
					setState(1126); table_name();
					setState(1127); match(DOT);
					}
					break;
				}
				setState(1131); column_name();
				}
				break;

			case 5:
				{
				setState(1132); function_name();
				setState(1133); match(OPEN_PAR);
				setState(1146);
				switch (_input.LA(1)) {
				case OPEN_PAR:
				case PLUS:
				...
				case BLOB_LITERAL:
					...
					case 1:
						{
						setState(1134); match(K_DISTINCT);
						}
						break;
					}
				...
				setState(1148); match(CLOSE_PAR);
				}
				break;

			case 6:
				{
				setState(1150); match(OPEN_PAR);
				setState(1151); expr(0);
				setState(1152); match(CLOSE_PAR);
				}
				break;

			case 7:
				{
				setState(1154); match(K_CAST);
				setState(1155); match(OPEN_PAR);
				setState(1156); expr(0);
				setState(1157); match(K_AS);
				setState(1158); type_name();
				setState(1159); match(CLOSE_PAR);
				}
				break;
			...
			case 8:
				...
				if (_la==K_EXISTS || _la==K_NOT) {
					...
					if (_la==K_NOT) {
						{
						setState(1161); match(K_NOT);
						}
					}

					setState(1164); match(K_EXISTS);
					}
				}

				setState(1167); match(OPEN_PAR);
				setState(1168); select_stmt();
				setState(1169); match(CLOSE_PAR);
				}
				break;

			case 9:
				{
				setState(1171); match(K_CASE);
				setState(1173);
				switch ( getInterpreter().adaptivePredict(_input,162,_ctx) ) {
				case 1:
					{
					setState(1172); expr(0);
					}
					break;
				}
				setState(1180); 
				...
				do {
					{
					{
					setState(1175); match(K_WHEN);
					setState(1176); expr(0);
					setState(1177); match(K_THEN);
					setState(1178); expr(0);
					}
					}
					setState(1182); 
					_errHandler.sync(this);
				...
				if (_la==K_ELSE) {
					{
					setState(1184); match(K_ELSE);
					setState(1185); expr(0);
					}
				}

				setState(1188); match(K_END);
				}
				break;

			case 10:
				{
				setState(1190); raise_function();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(1194); binary_operator();
						setState(1195); expr(14);
						}
						break;
					...
					case 2:
						...
						setState(1198); match(K_IS);
						setState(1200);
						switch ( getInterpreter().adaptivePredict(_input,166,_ctx) ) {
						case 1:
							{
							setState(1199); match(K_NOT);
							}
							break;
						}
						setState(1202); expr(7);
						}
						break;
					...
					case 3:
						...
						if (_la==K_NOT) {
							{
							setState(1204); match(K_NOT);
							}
						}

						setState(1207); match(K_BETWEEN);
						setState(1208); expr(0);
						setState(1209); match(K_AND);
						setState(1210); expr(6);
						}
						break;
					...
					case 5:
						...
						consume();
						setState(1220); expr(0);
						setState(1223);
						switch ( getInterpreter().adaptivePredict(_input,169,_ctx) ) {
						case 1:
							{
							setState(1221); match(K_ESCAPE);
							setState(1222); expr(0);
							}
							break;
						}
						}
					...
					case 6:
						...
						case K_ISNULL:
							{
							setState(1226); match(K_ISNULL);
							}
							break;
						case K_NOTNULL:
							{
							setState(1227); match(K_NOTNULL);
							}
							break;
						case K_NOT:
							{
							setState(1228); match(K_NOT);
							setState(1229); match(K_NULL);
							}
							break;
						default:
							throw new NoViableAltException(this);
					...
					case 7:
						...
						if (_la==K_NOT) {
							{
							setState(1233); match(K_NOT);
							}
						}

						setState(1236); match(K_IN);
						setState(1256);
						switch ( getInterpreter().adaptivePredict(_input,175,_ctx) ) {
						case 1:
							{
							setState(1237); match(OPEN_PAR);
							setState(1247);
							switch ( getInterpreter().adaptivePredict(_input,173,_ctx) ) {
							case 1:
								{
								setState(1238); select_stmt();
								}
								break;
						...
						case 2:
							...
							case 1:
								{
								setState(1250); database_name();
								setState(1251); match(DOT);
								}
								break;
							}
							setState(1255); table_name();
							}
							break;
						}
						}
	...
	public final Foreign_key_clauseContext foreign_key_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1263); match(K_REFERENCES);
			setState(1264); foreign_table();
			setState(1276);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1265); match(OPEN_PAR);
				setState(1266); column_name();
				setState(1271);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
			...
			while (_la==K_MATCH || _la==K_ON) {
				...
				case K_ON:
					...
					case 1:
						{
						setState(1280); match(K_SET);
						setState(1281); match(K_NULL);
						}
						break;

					case 2:
						{
						setState(1282); match(K_SET);
						setState(1283); match(K_DEFAULT);
						}
						break;

					case 3:
						{
						setState(1284); match(K_CASCADE);
						}
						break;

					case 4:
						{
						setState(1285); match(K_RESTRICT);
						}
						break;

					case 5:
						{
						setState(1286); match(K_NO);
						setState(1287); match(K_ACTION);
						}
						break;
					}
					}
			...
			case 1:
				...
				setState(1302); match(K_DEFERRABLE);
				setState(1307);
				switch ( getInterpreter().adaptivePredict(_input,184,_ctx) ) {
				case 1:
					{
					setState(1303); match(K_INITIALLY);
					setState(1304); match(K_DEFERRED);
					}
					break;

				case 2:
					{
					setState(1305); match(K_INITIALLY);
					setState(1306); match(K_IMMEDIATE);
					}
					break;
				}
				}
	...
	public final Raise_functionContext raise_function() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1311); match(K_RAISE);
			setState(1312); match(OPEN_PAR);
			setState(1317);
			switch (_input.LA(1)) {
			case K_IGNORE:
				{
				setState(1313); match(K_IGNORE);
				}
				break;
			case K_ABORT:
			case K_FAIL:
			case K_ROLLBACK:
				...
				setState(1316); error_message();
				}
				break;
			default:
				throw new NoViableAltException(this);
			}
			setState(1319); match(CLOSE_PAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Indexed_columnContext indexed_column() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1321); column_name();
			setState(1324);
			_la = _input.LA(1);
			if (_la==K_COLLATE) {
				{
				setState(1322); match(K_COLLATE);
				setState(1323); collation_name();
				}
			}
	...
	public final Table_constraintContext table_constraint() throws RecognitionException {
		...
		try {
			...
			if (_la==K_CONSTRAINT) {
				{
				setState(1329); match(K_CONSTRAINT);
				setState(1330); name();
				}
			}
			...
			case K_UNIQUE:
				...
				case K_PRIMARY:
					{
					setState(1333); match(K_PRIMARY);
					setState(1334); match(K_KEY);
					}
					break;
				case K_UNIQUE:
					{
					setState(1335); match(K_UNIQUE);
					}
					break;
				default:
					throw new NoViableAltException(this);
				...
				setState(1348); conflict_clause();
				}
				break;
			case K_CHECK:
				{
				setState(1350); match(K_CHECK);
				setState(1351); match(OPEN_PAR);
				setState(1352); expr(0);
				setState(1353); match(CLOSE_PAR);
				}
				break;
			case K_FOREIGN:
				{
				setState(1355); match(K_FOREIGN);
				setState(1356); match(K_KEY);
				setState(1357); match(OPEN_PAR);
				setState(1358); column_name();
				setState(1363);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				setState(1366); match(CLOSE_PAR);
				setState(1367); foreign_key_clause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final With_clauseContext with_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1371); match(K_WITH);
			setState(1373);
			switch ( getInterpreter().adaptivePredict(_input,194,_ctx) ) {
			case 1:
				{
				setState(1372); match(K_RECURSIVE);
				}
				break;
			}
			setState(1375); cte_table_name();
			setState(1376); match(K_AS);
			setState(1377); match(OPEN_PAR);
			setState(1378); select_stmt();
			setState(1379); match(CLOSE_PAR);
			setState(1389);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(1381); cte_table_name();
				setState(1382); match(K_AS);
				setState(1383); match(OPEN_PAR);
				setState(1384); select_stmt();
				setState(1385); match(CLOSE_PAR);
				}
				}
				setState(1391);
				_errHandler.sync(this);
	...
	public final Qualified_table_nameContext qualified_table_name() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1392); database_name();
				setState(1393); match(DOT);
				}
				break;
			}
			setState(1397); table_name();
			setState(1403);
			switch (_input.LA(1)) {
			case K_INDEXED:
				{
				setState(1398); match(K_INDEXED);
				setState(1399); match(K_BY);
				setState(1400); index_name();
				}
				break;
			case K_NOT:
				{
				setState(1401); match(K_NOT);
				setState(1402); match(K_INDEXED);
				}
				break;
			case EOF:
			case SCOL:
	...
	public final Ordering_termContext ordering_term() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1405); expr(0);
			setState(1408);
			_la = _input.LA(1);
			if (_la==K_COLLATE) {
				{
				setState(1406); match(K_COLLATE);
				setState(1407); collation_name();
				}
			}
	...
	public final Pragma_valueContext pragma_value() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				{
				setState(1415); match(STRING_LITERAL);
				}
				break;
			}
		}
	...
	public final Common_table_expressionContext common_table_expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1418); table_name();
			setState(1430);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1419); match(OPEN_PAR);
				setState(1420); column_name();
				setState(1425);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Result_columnContext result_column() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1438); table_name();
				setState(1439); match(DOT);
				setState(1440); match(STAR);
				}
				break;
			...
			case 3:
				...
				if (_la==K_AS || _la==IDENTIFIER || _la==STRING_LITERAL) {
					...
					if (_la==K_AS) {
						{
						setState(1443); match(K_AS);
						}
					}

					setState(1446); column_alias();
					}
				}
	...
	public final Table_or_subqueryContext table_or_subquery() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				case 1:
					{
					setState(1451); database_name();
					setState(1452); match(DOT);
					}
					break;
				}
				setState(1456); table_name();
				setState(1461);
				...
				case 1:
					...
					case 1:
						{
						setState(1457); match(K_AS);
						}
						break;
					}
					setState(1460); table_alias();
					}
					break;
				}
				setState(1468);
				...
				case K_INDEXED:
					...
					setState(1464); match(K_BY);
					setState(1465); index_name();
					}
					break;
				case K_NOT:
					{
					setState(1466); match(K_NOT);
					setState(1467); match(K_INDEXED);
					}
					break;
				case EOF:
				case SCOL:
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1470); match(OPEN_PAR);
				setState(1480);
				switch ( getInterpreter().adaptivePredict(_input,211,_ctx) ) {
				case 1:
					{
					setState(1471); table_or_subquery();
					setState(1476);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
						{
						{
						setState(1472); match(COMMA);
						setState(1473); table_or_subquery();
						}
						}
						setState(1478);
						_errHandler.sync(this);
			...
			case 3:
				...
				case 1:
					...
					case 1:
						{
						setState(1492); match(K_AS);
						}
						break;
					}
					setState(1495); table_alias();
					}
					break;
				}
				}
	...
	public final Join_clauseContext join_clause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1500); table_or_subquery();
			setState(1507);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA || _la==K_CROSS || ((((_la - 87)) & ~0x3f) == 0 && ((1L << (_la - 87)) & ((1L << (K_INNER - 87)) | (1L << (K_JOIN - 87)) | (1L << (K_LEFT - 87)) | (1L << (K_NATURAL - 87)))) != 0)) {
				{
				{
				setState(1501); join_operator();
				setState(1502); table_or_subquery();
				setState(1503); join_constraint();
				}
				}
				setState(1509);
				_errHandler.sync(this);
	...
	public final Join_operatorContext join_operator() throws RecognitionException {
		...
		try {
			...
			case K_NATURAL:
				...
				case K_LEFT:
					{
					setState(1514); match(K_LEFT);
					setState(1516);
					_la = _input.LA(1);
					if (_la==K_OUTER) {
						{
						setState(1515); match(K_OUTER);
						}
					}
				...
				case K_INNER:
					{
					setState(1518); match(K_INNER);
					}
					break;
				case K_CROSS:
					{
					setState(1519); match(K_CROSS);
					}
					break;
				case K_JOIN:
					break;
	...
	public final Join_constraintContext join_constraint() throws RecognitionException {
		...
		try {
			...
			case K_ON:
				{
				setState(1525); match(K_ON);
				setState(1526); expr(0);
				}
				break;
			case K_USING:
				{
				setState(1527); match(K_USING);
				setState(1528); match(OPEN_PAR);
				setState(1529); column_name();
				setState(1534);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Select_coreContext select_core() throws RecognitionException {
		...
		try {
			...
			case K_SELECT:
				...
				if (_la==K_FROM) {
					{
					setState(1553); match(K_FROM);
					setState(1563);
					switch ( getInterpreter().adaptivePredict(_input,227,_ctx) ) {
					case 1:
						{
						setState(1554); table_or_subquery();
						setState(1559);
						_errHandler.sync(this);
						_la = _input.LA(1);
						while (_la==COMMA) {
				...
				if (_la==K_WHERE) {
					{
					setState(1567); match(K_WHERE);
					setState(1568); expr(0);
					}
				}
				...
				if (_la==K_GROUP) {
					{
					setState(1571); match(K_GROUP);
					setState(1572); match(K_BY);
			...
			case K_VALUES:
				enterOuterAlt(_localctx, 2);
				{
				setState(1587); match(K_VALUES);
				setState(1588); match(OPEN_PAR);
				setState(1589); expr(0);
				setState(1594);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
				...
				while (_la==COMMA) {
					...
					setState(1599); match(OPEN_PAR);
					setState(1600); expr(0);
					setState(1605);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
	...
	public final Compound_operatorContext compound_operator() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(1618); match(K_UNION);
				setState(1619); match(K_ALL);
				}
				break;
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(1620); match(K_INTERSECT);
				}
				break;
	...
	public final Cte_table_nameContext cte_table_name() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1624); table_name();
			setState(1636);
			_la = _input.LA(1);
			if (_la==OPEN_PAR) {
				{
				setState(1625); match(OPEN_PAR);
				setState(1626); column_name();
				setState(1631);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==COMMA) {
	...
	public final Signed_numberContext signed_number() throws RecognitionException {
		...
		try {
			...
			setState(1641); match(NUMERIC_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Error_messageContext error_message() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(1647); match(STRING_LITERAL);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Binary_operatorContext binary_operator() throws RecognitionException {
		...
		enterRule(_localctx, 122, RULE_binary_operator);
		int _la;
		try {
			setState(1670);
			switch (_input.LA(1)) {
			...
			case K_REGEXP:
				...
				case 1:
					{
					setState(1654); match(ASSIGN);
					}
					break;

				case 2:
					{
					setState(1655); match(EQ);
					}
					break;

				case 3:
					{
					setState(1656); match(NOT_EQ1);
					}
					break;

				case 4:
					{
					setState(1657); match(NOT_EQ2);
					}
					break;

				case 5:
					{
					setState(1658); match(K_IS);
					}
					break;

				case 6:
					{
					setState(1659); match(K_IS);
					setState(1660); match(K_NOT);
					}
					break;

				case 7:
					{
					setState(1661); match(K_IN);
					}
					break;

				case 8:
					{
					setState(1662); match(K_LIKE);
					}
					break;

				case 9:
					{
					setState(1663); match(K_GLOB);
					}
					break;

				case 10:
					{
					setState(1664); match(K_MATCH);
					}
					break;

				case 11:
					{
					setState(1665); match(K_REGEXP);
					}
					break;
				}
				}
			...
			case K_AND:
				...
				{
				setState(1668); match(K_AND);
				}
				break;
			case K_OR:
				enterOuterAlt(_localctx, 8);
				{
				setState(1669); match(K_OR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Any_nameContext any_name() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 1);
				{
				setState(1714); match(IDENTIFIER);
				}
				break;
			case K_ABORT:
			case K_ACTION:
			...
			case K_WITHOUT:
				enterOuterAlt(_localctx, 2);
				{
				setState(1715); keyword();
				}
				break;
			case STRING_LITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(1716); match(STRING_LITERAL);
				}
				break;
			case OPEN_PAR:
				enterOuterAlt(_localctx, 4);
				{
				setState(1717); match(OPEN_PAR);
				setState(1718); any_name();
				setState(1719); match(CLOSE_PAR);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		")\u04d1\n)\3)\3)\5)\u04d5\n)\3)\3)\3)\3)\3)\3)\7)\u04dd\n)\f)\16)\u04e0"+
		"\13)\5)\u04e2\n)\3)\3)\3)\3)\5)\u04e8\n)\3)\5)\u04eb\n)\7)\u04ed\n)\f"+
		")\16)\u04f0\13)\3*\3*\3*\3*\3*\3*\7*\u04f8\n*\f*\16*\u04fb\13*\3*\3*\5"+
		"*\u04ff\n*\3*\3*\3*\3*\3*\3*\3*\3*\3*\3*\5*\u050b\n*\3*\3*\5*\u050f\n"+
		"*\7*\u0511\n*\f*\16*\u0514\13*\3*\5*\u0517\n*\3*\3*\3*\3*\3*\5*\u051e"+
		"\n*\5*\u0520\n*\3+\3+\3+\3+\3+\3+\5+\u0528\n+\3+\3+\3,\3,\3,\5,\u052f"+
		"\n,\3,\5,\u0532\n,\3-\3-\5-\u0536\n-\3-\3-\3-\5-\u053b\n-\3-\3-\3-\3-"+
		"\7-\u0541\n-\f-\16-\u0544\13-\3-\3-\3-\3-\3-\3-\3-\3-\3-\3-\3-\3-\3-\3"+
		"-\7-\u0554\n-\f-\16-\u0557\13-\3-\3-\3-\5-\u055c\n-\3.\3.\5.\u0560\n."+
		"\3.\3.\3.\3.\3.\3.\3.\3.\3.\3.\3.